...
namespace Microsoft.Azure.WebJobs.ServiceBusSessions.Triggers
{
    ...
    internal class ServiceBusSessionTriggerAttributeBindingProvider : ITriggerBindingProvider
    {
        ...
        private readonly SessionProvider _messagingProvider;
        ...
        public Task<ITriggerBinding> TryCreateAsync(TriggerBindingProviderContext context)
        {
            ...
            if (queueName != null)
            {
                binding = new ServiceBusSessionTriggerBinding(parameter.Name, parameter.ParameterType, argumentBinding, account, _options, _messagingProvider, queueName);
            }
            else
            {
                binding = new ServiceBusSessionTriggerBinding(parameter.Name, parameter.ParameterType, argumentBinding, account, _options, _messagingProvider, topicName, subscriptionName);
            }
